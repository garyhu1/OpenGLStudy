...
public class MyTextureRenderer implements GLSurfaceView.Renderer {
    ...
    public MyTextureRenderer(Context context, String vertex, String fragment){
        ...
        try {
            setBitmap(BitmapFactory.decodeStream(context.getResources().getAssets().open("texture/fengj.png")));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
